...
const BLOCKS = [
  ...
  new ContentBlock({
    ...
    characterList: Immutable.List(
      Immutable.Repeat(
        CharacterMetadata.create({style: BOLD, entity2nd: ENTITY_KEY}),
        5,
      ),
    ),
  }),
  ...
  new ContentBlock({
    ...
    characterList: Immutable.List(
      Immutable.Repeat(
        CharacterMetadata.create({style: ITALIC, entity2nd: null}),
        7,
      ),
    ),
  }),
...
}).createEntity('IMAGE', 'IMMUTABLE', null, 2);

let editorState = EditorState.createWithContent(contentState);
editorState = EditorState.forceSelection(editorState, selectionState);

const getSampleStateForTestingWithEntityAtSecondLayer = (): {
...
module.exports = getSampleStateForTestingWithEntityAtSecondLayer;
